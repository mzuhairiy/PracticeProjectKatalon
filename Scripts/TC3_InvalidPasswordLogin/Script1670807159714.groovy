...
WebUI.setText(findTestObject('Login Page/input Password'), 'wrongpass')

WebUI.click(findTestObject('Login Page/btn Login'))

WebUI.verifyElementPresent(findTestObject('Login Page/alert InvalidPassword'), 0)
